...
- 当前最小参考实现覆盖 Starter、Specflow、Knowledge、项目级兼容 Skill 安装、发布白名单、确定性契约检查和仓库静态检查；
...
- Skill 的原生安装、更新、权限、Sandbox、Hook、MCP 和会话行为由目标 Host 负责；本仓 Manifest 只证明发布白名单和内容摘要。
...
| Skill 发布版本 | Distribution Manifest 与源目录摘要 | 维护者、Host 原生发布流程、兼容 Harness | 影响发布白名单和内容可复核版本 |
