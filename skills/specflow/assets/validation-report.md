...
| --- | --- | --- | --- | --- |
|  |  |  | 同源说明 / 执行观察 / 交叉验证 | pass / partial / fail |

- [ ] 没有把设计说明、自生成检查清单或无外部观察的 Agent 复述作为唯一正确性证据。
- [ ] 高风险契约的 Evidence 覆盖实际行为，并说明候选版本和适用范围。
- [ ] 单一验证渠道无法覆盖的盲区已经通过交叉验证或明确的“尚未证明”保留。

## 结构与内容检查

- [ ] Meta 与 Spec 存在且 ID 一致；Meta 声明的其他非空产物均存在。
