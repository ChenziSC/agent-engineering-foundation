...
| 全仓回归 | 全量 117/117；规模 2/2；Repository、Doctor、Distribution、Knowledge、Specflow | pass |
...
- `local-verified / publish-pending`：本地和隔离验证已完成，仓库 Secret 已配置；本次只执行 Commit/Push，Tag 与 npm 发布继续等待单独授权。
