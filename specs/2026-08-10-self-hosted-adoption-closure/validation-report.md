...
- 迁移后的真实 Codex 新会话将 `/Users/bytedance/Documents/vscodeProjects/agent-engineering-foundation/.agents/skills` 注册为项目 Skill 根，并发现其中 9 个本仓 Skill，补齐 Host 侧 Source Link 发现证据。
